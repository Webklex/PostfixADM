        ...
        <div flex-xs flex-gt-xs="50" flex-gt-sm="50" flex-gt-md="25" flex-gt-lg="10" layout="row">
            ...
            <form role="form" name="authForm" method="POST" action="/alias/update/{{$mAlias->id}}" autocomplete="off">
                ...
                <md-card md-theme="default">
                    <md-card-title>
                        <md-card-title-text>
                            <span class="md-headline">@t('Alias aktualisieren')</span>
                        ...
                        <md-input-container flex="100">
                            ...
                            <div ng-messages="authForm.source.$error" role="alert">
                                <div ng-message-exp="['required', 'minlength', 'maxlength']">
                                    @t('Die angegebene Quelladresse muss mindestens 5 Zeichen lang sein.')
                                </div>
                            </div>
                        </md-input-container>
                    ...
                    <md-card-actions layout="row" layout-align="end center">
                        <md-button type="submit">@t('Alias aktualisieren')</md-button>
                    </md-card-actions>
                </md-card>
            </form>
        </div>
