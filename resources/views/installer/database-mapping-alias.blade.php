...
<div class="md-headline" layout="row">
    <div flex>@t('Aliasmapping definieren')</div>
    <md-select ng-model="vm.data.alias.table" class="mt-0 mb-16" placeholder="@t('Tabelle')" flex>
...
<div flex="100" layout="row"  ng-show="vm.data.alias.table != 'null' && vm.data.alias.table != null">
    @include('installer.database-mapping-map', [
        'title'   => _t('Quell Adresse'),
        'matrix'  => $matrix,
        'field'   => 'source',
        'section' => 'alias',
    ])
    @include('installer.database-mapping-map', [
        'title'   => _t('Ziel Adressen'),
        'matrix'  => $matrix,
        'field'   => 'destination',
        'section' => 'alias',
    ])
