...
@section('content')
    <md-content class="md-padding" layout-xs="column" layout="row" layout-wrap layout-align="center center">
        <div flex>
            ...
            <h1 class="md-title">Übersicht aller verfügbaren Mailboxen</h1>
                    ...
                    <md-list-item>
                        ...
                        <md-menu class="md-secondary">
                            ...
                            <md-menu-content width="3">
                                <md-menu-item>
                                    <a class="md-button" href="/mailbox/update/{{$mMailbox->id}}">Bearbeiten</a>
                                </md-menu-item>
                                <md-menu-item>
                                    <a class="md-button" href="/mailbox/delete/{{$mMailbox->id}}">Löschen</a>
                                </md-menu-item>
                            </md-menu-content>
                        </md-menu>
                    </md-list-item>
